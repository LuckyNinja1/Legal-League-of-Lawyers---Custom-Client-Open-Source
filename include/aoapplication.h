...
public:
  ...
  bool lll_ic_support_enabled = false;
  ...
  int get_lll_release() const { return LLL_RELEASE; }
  int get_lll_major() const { return LLL_MAJOR; }
  int get_lll_minor() const { return LLL_MINOR; }
  QString get_lll_version_string();
  ...
  QString get_custom_lightbulb(QString p_char);
  QString get_custom_whack(QString p_char);
  QString get_custom_whoops(QString p_char);

  // Returns the custom psyche-locks used by theme
  QString get_custom_lock_chains(QString p_char);
  QString get_custom_lock_locked(QString p_char);
  QString get_custom_lock_break(QString p_char);
  QString get_custom_lock_success(QString p_char);
...
private:
  ...
  const int LLL_RELEASE = 1;
  const int LLL_MAJOR = 0;
  const int LLL_MINOR = 1;
