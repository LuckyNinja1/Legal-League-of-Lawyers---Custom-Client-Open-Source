...
private:
  ...
  //same as realization however for LLL's CC realization buttons
  QTimer *lightbulb_timer;
  QTimer *whack_timer;
  QTimer *whoops_timer;
  ...
  AOImage *ui_vp_lightbulb;
  AOImage *ui_vp_whack;
  AOImage *ui_vp_whoops;
  AOMovie *ui_vp_wtce;
...
private slots:
  ...
  void on_whack_clicked();
  void on_whoops_clicked();
