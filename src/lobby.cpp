...
void Lobby::set_widgets()
{
  ...
  ui_version->setText(tr("Version: %1 | LLL Version: %2").arg(ao_app->get_version_string(), ao_app->get_lll_version_string()));
...
void Lobby::on_about_clicked()
{
  QString msg = tr("<h2>Attorney Online %1</h2>"
                   ...
                   "Noevain, Cronnicossy"
                   "<p><b>LLL Special Thanks:</p><br>"
                   "Lystra (LLL Owner), Robert (Server Hosting), Lucky (Customizing Client),"
                   "Failure (Theme & Characters) and LLL Staff (DankPies, Senpai)")
          .arg(ao_app->get_version_string(), ao_app->get_lll_version_string());
