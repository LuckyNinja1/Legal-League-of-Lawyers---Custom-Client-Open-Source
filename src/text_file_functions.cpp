...
QString AOApplication::get_custom_lightbulb(QString p_char)
{
  QString f_result = read_char_ini(p_char, "lightbulb", "Options");

  if (f_result == "")
    return get_sfx("lightbulb");
  else return f_result;
}

QString AOApplication::get_custom_whack(QString p_char)
{
  QString f_result = read_char_ini(p_char, "whack", "Options");

  if (f_result == "")
    return get_sfx("whack");
  else return f_result;
}

QString AOApplication::get_custom_whoops(QString p_char)
{
  QString f_result = read_char_ini(p_char, "whoops", "Options");

  if (f_result == "")
    return get_sfx("whoops");
  else return f_result;
}

QString AOApplication::get_custom_lock_chains(QString p_char)
{
  QString f_result = read_char_ini(p_char, "locks_chains", "Options");

  if (f_result == "")
    return get_sfx("lock_chains");
  else return f_result;
}

QString AOApplication::get_custom_lock_locked(QString p_char)
{
  QString f_result = read_char_ini(p_char, "locks_locked", "Options");

  if (f_result == "")
    return get_sfx("lock_locked");
  else return f_result;
}

QString AOApplication::get_custom_lock_break(QString p_char)
{
  QString f_result = read_char_ini(p_char, "locks_break", "Options");

  if (f_result == "")
    return get_sfx("locks_break");
  else return f_result;
}
